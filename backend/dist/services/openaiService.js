...
exports.generateChatAssistantOutput = generateChatAssistantOutput;
...
async function generateChatAssistantOutput(params) {
    const apiKey = process.env.OPENAI_API_KEY;
    if (!apiKey) {
        return {
            action: "unknown",
            reply: "AI scheduling is temporarily unavailable because OPENAI_API_KEY is missing.",
        };
    }
